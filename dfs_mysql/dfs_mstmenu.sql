...
CREATE TABLE `mstmenu` (
  ...
  `menuLinkURL` varchar(255) DEFAULT NULL,
...
LOCK TABLES `mstmenu` WRITE;
/*!40000 ALTER TABLE `mstmenu` DISABLE KEYS */;
/*!40000 ALTER TABLE `mstmenu` ENABLE KEYS */;
UNLOCK TABLES;
