                                ...
                                <%
                                    ...
                                    if(uid!=null){
                                        ...
                                        if(rs.next()){                                            
                                            ...
                                            String read = rs. getString("isReadyOnly");
                                            String add = rs.getString("addressID");
...
//                                            PreparedStatement 
					...
					<div class="section">
						...
						<div class="input password">
                                                    <input type="password" name="pass"  placeholder="Password" maxlength="15" readonly="true" disabled="true" />
						</div>
						<div class="clear"> </div>
					</div>
					<div class="section">
						<div class="input-sign email">
                                                    <input type="tel" name="cno" placeholder="Mobile Number" value="<%=cno%>" maxlength="15" style="border: none;padding:2%" /> 
						</div>
						<div class="input-sign re-email">
                                                    <input type="email" name="email" placeholder="Email" value="<%=email%>"  onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Please enter your email';}"required />
						</div>
						<div class="clear"> </div>
					</div>
				</div>
		            ...
		            <option value="ZW">Zimbabwe</option>
                                        ...
                                        <div class="section-country">
                                            <select id="sq" name="secq" onchange="change_sq(this.value)" class="frm-field required">
                                                ...
                                                <%
                                                    PreparedStatement ptsts = connection.setConnection().prepareStatement("select * from mstcoderegister where codename like '%security%'");
                                                    ResultSet rss = ptsts.executeQuery();
                                                    while (rs.next()){
