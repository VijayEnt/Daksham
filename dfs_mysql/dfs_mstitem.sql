...
CREATE TABLE `mstitem` (
  ...
  `itemRatePerUnit` int(11) DEFAULT NULL,
  `itemQntyPerKG` int(11) DEFAULT NULL,
  `itemRatePerKG` int(11) NOT NULL,
  `isActive` varchar(5) DEFAULT 'Y',
  `gstPercent` int(11) NOT NULL,
  `creationDate` datetime NOT NULL,
  `actionDate` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `actionUserID` int(11) NOT NULL,
  PRIMARY KEY (`itemID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Item Master';
